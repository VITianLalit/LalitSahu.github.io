...
class _ArtifactScreenState extends State<ArtifactCarouselScreen> {
  ...
  void _handleArtifactTap(int index) {
    ...
    if (delta == 0) {
      dynamic data = projectImage[index % projectImage.length];
  ...
  var projectImage = [
    ...
    'assets/images/projects/eventeaze.png',
    'assets/images/projects/ecommerce.png',
    'assets/images/projects/culturalRepo.png',
    'assets/images/projects/face.png',
    'assets/images/projects/socks.png',
  ];
  ...
  var projectLink = [
    'https://github.com/VITianLalit/chat_application.github.io',
    'https://github.com/VITianLalit/EventEaze.github.io',
    'https://github.com/VITianLalit/ApnaMart.github.io',
    'https://github.com/VITianLalit/Cultural_Repository',
    'https://github.com/VITianLalit/Marvel_Heroes_Recognizer_Application',
    'https://github.com/VITianLalit/Socks_Shop_Application_ui_design_flutter_ui_challenge_20.github.io-'
    ];
  ...
  Widget build(BuildContext context) {
    ...
    final pages = projectImage.map((e) {
      return Padding(
        padding: const EdgeInsets.all(10),
        child: _DoubleBorderImage(path: e),
      );
    }).toList();
      ...
      children: [
        ...
        Positioned.fill(
          child: ValueListenableBuilder<int>(
              ...
              builder: (_, value, __) {
                return _BlurredImageBg(url: projectImage[value]);
              }),
        ),
