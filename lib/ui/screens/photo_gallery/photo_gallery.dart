...
class _PhotoGalleryState extends State<PhotoGallery> {
                    ...
                    child: TweenAnimationBuilder<Offset>(
                      ...
                      child: FocusTraversalGroup(
                        ...
                        child: GridView.count(
                          ...
                          children: List.generate(20, (i) => _buildImage(i, swipeDuration, imgSize)),
                        ),
                      ),
                    ),
                  ),
  ...
  Widget _buildImage(int index, Duration swipeDuration, Size imgSize) {
    ...
    var arr = [
      'assets/images/certificate/acropolish.png',
      'assets/images/certificate/agoda.jpg',
      'assets/images/certificate/amazon.jpg',
      'assets/images/certificate/blockchain.png',
      'assets/images/certificate/ethicalHacking.jpeg',
      'assets/images/certificate/cisco.png',
      'assets/images/certificate/gfgWorkShop.png',
      'assets/images/certificate/google.jpeg',
      'assets/images/certificate/iim.png',
      'assets/images/certificate/hero.png',
      'assets/images/certificate/mi.jpg',
      'assets/images/certificate/java.png',
      'assets/images/certificate/open.png',
      'assets/images/certificate/postman.png',
      'assets/images/certificate/RBI.jpeg',
      'assets/images/certificate/psbasic.png',
      'assets/images/certificate/roadmap.png',
      'assets/images/certificate/scaler.png',
      'assets/images/certificate/wce.png',
      'assets/images/certificate/techno.png',
      'assets/images/certificate/sqlBasic.png',
    ];
