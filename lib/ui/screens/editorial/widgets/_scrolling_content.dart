                ...
                child: Column(children: [
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    IconButton(
                      ...
                      onPressed: () => launchUrl(Uri.parse('https://github.com/VITianLalit')),
                    ),
                    IconButton(
                      icon: const FaIcon(FontAwesomeIcons.linkedin,  color: Colors.black),
                      onPressed: () => launchUrl(Uri.parse('https://www.linkedin.com/in/lalit-sahu/')),
                    ),
                    IconButton(
                      icon: const FaIcon(FontAwesomeIcons.globe, color: Colors.black),
                      onPressed: () => launchUrl(Uri.parse('https://codolio.com/profile/Lalit_Sahu')),
                    ),
                    IconButton(
                      icon: const FaIcon(FontAwesomeIcons.envelope, color: Colors.black),
                      onPressed: () => launchUrl(Uri.parse('mailto:lalitsahuji786.com')),
                    ),
